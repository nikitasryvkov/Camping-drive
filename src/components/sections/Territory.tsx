    ...
    <section id="territory" className="section-space scroll-mt-24">
      <Container>
        ...
        <div className="mt-12 grid gap-5 lg:grid-cols-12 lg:grid-rows-[auto_auto]">
          ...
          <Reveal className="overflow-hidden rounded-4xl border border-border bg-surface lg:col-span-5">
            <a
              href="/media/territory-scheme.png"
              target="_blank"
              rel="noreferrer"
              aria-label="Открыть схему расположения объектов в полном размере"
              className="block bg-[#93c527] transition-opacity hover:opacity-95 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-accent"
            >
              <img
                src="/media/territory-scheme.png"
                alt="Схема расположения объектов на территории базы Глэмпинг Юнити"
                width="1383"
                height="1802"
                loading="lazy"
